...
# if st.session_state["get_local_storage_v"] != "": # and st.session_state["test_get_click_btn"] == True:
#     if st.session_state["get_storage"] != None and st.session_state["get_storage"]["data"] == "nothing":
#         st.session_state["get_storage"] = {"item": st.session_state["get_local_storage_v"], "data": "nothing"}
#     else:
#         val_ = localS.getItem(st.session_state["get_local_storage_v"], key="test_get_item")
#         st.session_state["get_storage"] = st.session_state["test_get_item"]
...
#     itemKey_ = st.session_state["local_storage_delete_key"]
#     localS.deleteItem(itemKey_) 
#     st.session_state["get_storage"] = {"item":itemKey_, "data":"nothing"}
